...
ARCHETYPES: Dict[str, Archetype] = {
    "warden": Archetype(
        ...
        passive="Stalwart: +3 defense to every blow you take. Your ally's support is bolstered.",
        defense_bonus=3,
        pool=[("power_strike", 2), ("second_wind", 4), ("rend", 6), ("bulwark", 8),
              ("rallying_cry", 10), ("crushing_blow", 12)],
    ),
    "trickster": Archetype(
        id="trickster",
        name="Trickster",
        description="A quick, vicious fighter who opens wounds and presses the advantage.",
        passive="Deadly: +3 damage to every blow you land. Your ally strikes harder.",
        attack_bonus=3,
        pool=[("quick_strike", 2), ("rupture", 4), ("power_strike", 6), ("rend", 8),
              ("lacerate", 10), ("eviscerate", 12)],
    ),
    "channeler": Archetype(
        id="channeler",
        name="Channeler",
        description="A wielder of raw power — fire, force, and the breath to fight on.",
        passive="Attuned: your abilities recharge 30% faster. Your ally grows loyal twice as fast.",
        cooldown_mult=0.7,
        pool=[("firebolt", 2), ("second_wind", 4), ("cleave", 6), ("rupture", 8),
              ("chain_lightning", 10), ("inferno", 12)],
    ),
}
